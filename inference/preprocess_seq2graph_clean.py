    ...
    def correct_masks(self, min_cell_size):
        ...
        for ind_data in range(self.__len__()):
            ...
            if per_cell_change or per_mask_change:
                ...
                io.imsave(result_path, result.astype(np.uint16), compression=6)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-ii', type=str, default="../datasets/Fluo-N2DH-SIM+/Test/01",
                        help='input images directory')
    parser.add_argument('-iseg', type=str, default="../datasets/Fluo-N2DH-SIM+/Test/01_SEG",
                        help='input segmentation directory')
    parser.add_argument('-im', type=str, default="../models/Features_Models/Fluo-N2DH-SIM+/all_params.pth",
                        help='metric learning model params directory')
    parser.add_argument('-cs', type=int, default=20, help='min cell size')
    parser.add_argument('-oc', type=str, default="../datasets/Fluo-N2DH-SIM+/Test/01_CSV",
