...
if __name__ == "__main__":
    ...
    parser.add_argument('-mp', type=str, default="../logs/runs/2025-02-24/16-31-54/checkpoints/epoch=66.ckpt", help='model params full path')

    parser.add_argument('-ns', type=str, default="01", help='number of sequence - string 01/02')
    # 序号用于下方补充完整路径 oc/序号_CSV（上一步提取的特征CSV文件夹路径） ，生成的推理文件位于 序号_RES_inference
    parser.add_argument('-oc', type=str, default="../datasets/Fluo-N2DH-SIM+/Test", help='output csv directory')
